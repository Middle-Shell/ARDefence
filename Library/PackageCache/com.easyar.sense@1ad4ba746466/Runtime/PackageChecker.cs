...
#error EasyAR Mega support is not enabled in this version, please use a newer package.
#endif
#if EASYAR_ENABLE_CLOUDSPATIALMAP
#warning This version is obsolete for EasyAR Meta, please use EasyAR Mega SDK and Tools.
#endif
#if EASYAR_ENABLE_CLOUDSPATIALMAP_NOTSUPPORT
#error EasyAR SpatialMap package < 4.5.0 is NOT supported.
#endif
