...
namespace easyar
{
    ...
    internal static partial class Detail
    {
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void easyar_CloudLocalizer_resolve(IntPtr This, IntPtr inputFrame, IntPtr message, OptionalOfVec3F acceleration, OptionalOfVec3D location, OptionalOfInt timeoutMilliseconds, IntPtr callbackScheduler, FunctorOfVoidFromCloudLocalizeResult callback);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
    ...
    public enum EngineOperatingSystem
    {
        Windows = 0,
        Linux = 1,
        MacOS = 2,
    ...
    public class Engine
    {
        ...
        {
            if (Detail.easyar_Engine_schemaHash() != -1570438390)
            {
