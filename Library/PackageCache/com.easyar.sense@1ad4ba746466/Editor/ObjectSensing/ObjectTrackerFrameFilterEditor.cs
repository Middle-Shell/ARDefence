...
namespace easyar
{
    ...
    public class ObjectTrackerFrameFilterEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            var enableMotionFusion = serializedObject.FindProperty("enableMotionFusion");
            ...
            ((ObjectTrackerFrameFilter)target).EnableMotionFusion = enableMotionFusion.boolValue;
        }
    }
}
