...
namespace easyar
{
    [CustomEditor(typeof(HuaweiAREngineFrameSource), true)]
    public class HuaweiAREngineFrameSourceEditor : FrameSourceEditor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();
            var fs = target as HuaweiAREngineFrameSource;
